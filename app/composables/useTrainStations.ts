...
export const useTrainStations = () => {
  ...
  const opcaoPaises = ref<Record<string, unknown>>({});
  const opcaoTipos = ref<Record<string, unknown>>({});
  const opcaoCategorias = ref<Record<string, unknown>>({});
  const opcaoLatitude = ref<Record<string, unknown>>({});
  const opcaoLongitude = ref<Record<string, unknown>>({});
  const opcaoTiposPorPais = ref<Record<string, unknown>>({});
