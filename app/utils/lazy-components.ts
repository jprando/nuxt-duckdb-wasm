...
export const LazyGraficoEChartBarra = defineAsyncComponent(() =>
  import('~/components/GraficoEChartBarra.vue')
);

export const LazyGraficoEChartLinha = defineAsyncComponent(() =>
  import('~/components/GraficoEChartLinha.vue')
);

export const LazyGraficoEChartPizza = defineAsyncComponent(() =>
  import('~/components/GraficoEChartPizza.vue')
);

export const LazyGraficoEChartRadar = defineAsyncComponent(() =>
  import('~/components/GraficoEChartRadar.vue')
);

export const LazyGraficoEChartSankey = defineAsyncComponent(() =>
  import('~/components/GraficoEChartSankey.vue')
);

export const LazyGraficoEChartChord = defineAsyncComponent(() =>
  import('~/components/GraficoEChartChord.vue')
);

export const LazyGraficoEChartHeatmap = defineAsyncComponent(() =>
