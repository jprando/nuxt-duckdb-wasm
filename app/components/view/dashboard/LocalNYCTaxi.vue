  ...
  <div class="p-4 md:p-6 space-y-5">
      ...
      <UCard :ui="{ body: 'p-4!' }" class="overflow-hidden">
        <div class="flex items-start gap-3">
          <div class="p-2 rounded-lg bg-warning/10 shrink-0">
            <UIcon name="i-lucide-circle-dollar-sign" class="size-5 text-warning" />
          </div>
          <div class="min-w-0">
            <p class="text-xs text-muted mb-0.5">
              Valor Médio
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        ...
        <LazyGraficoEChart v-else :option="opcaoVendor" :tema="temaGrafico" :height="260" />
      </UCard>

      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-users" class="text-success size-4" />
        ...
        <LazyGraficoEChart v-else :option="opcaoPassageiros" :tema="temaGrafico" :height="260" />
      </UCard>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-ruler" class="text-warning size-4" />
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-dollar-sign" class="text-secondary size-4" />
        ...
        <LazyGraficoEChart v-else :option="opcaoValor" :tema="temaGrafico" :height="260" />
      </UCard>
    </div>
