  ...
  <div class="p-4 md:p-6 space-y-5">
      ...
      <UCard :ui="{ body: 'p-4!' }" class="overflow-hidden">
        <div class="flex items-start gap-3">
          <div class="p-2 rounded-lg bg-secondary/10 shrink-0">
            <UIcon name="i-lucide-alarm-clock" class="size-5 text-secondary" />
          </div>
          <div class="min-w-0">
            <p class="text-xs text-muted mb-0.5">
              Atraso Médio Chegada
      ...
      <UCard :ui="{ body: 'p-4!' }" class="overflow-hidden">
        <div class="flex items-start gap-3">
          <div class="p-2 rounded-lg bg-info/10 shrink-0">
            <UIcon name="i-lucide-ruler" class="size-5 text-info" />
          </div>
          <div class="min-w-0">
            <p class="text-xs text-muted mb-0.5">
              Distância Média
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-building" class="text-primary size-4" />
            Voos por Companhia Aérea
          </h2>
        </template>
        <template v-if="carregando">
        ...
        <LazyGraficoEChart v-else :option="opcaoCompanhias" :tema="temaGrafico" :height="300" />
      </UCard>
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-pie-chart" class="text-success size-4" />
            Status dos Voos
          </h2>
        </template>
        <template v-if="carregando">
        ...
        <LazyGraficoEChart v-else :option="opcaoStatus" :tema="temaGrafico" :height="300" />
      </UCard>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-calendar-days" class="text-warning size-4" />
        ...
        <LazyGraficoEChart v-else :option="opcaoDiaSemana" :tema="temaGrafico" :height="240" />
      </UCard>
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        ...
        <LazyGraficoEChart v-else :option="opcaoMensal" :tema="temaGrafico" :height="240" />
      </UCard>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-hourglass" class="text-error size-4" />
        ...
        <LazyGraficoEChart v-else :option="opcaoAtrasoPartida" :tema="temaGrafico" :height="260" />
      </UCard>
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-map" class="text-secondary size-4" />
        ...
        <LazyGraficoEChart v-else :option="opcaoDistancia" :tema="temaGrafico" :height="260" />
      </UCard>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-map-pin" class="text-success size-4" />
            Top 12 Aeroportos de Origem
          </h2>
        </template>
        <template v-if="carregando">
        ...
        <LazyGraficoEChart v-else :option="opcaoAeroportos" :tema="temaGrafico" :height="300" />
      </UCard>
      ...
      <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
        <template #header>
          <h2 class="text-sm font-semibold flex items-center gap-1.5">
            <UIcon name="i-lucide-ban" class="text-error size-4" />
            Taxa de Cancelamento por Companhia (%)
          </h2>
        </template>
        <template v-if="carregando">
        ...
        <LazyGraficoEChart v-else :option="opcaoCancelamentos" :tema="temaGrafico" :height="300" />
      </UCard>
    </div>
    ...
    <UCard :ui="{ header: 'pb-2!', body: 'pt-0!' }">
      ...
      <LazyGraficoEChart v-else :option="opcaoHoraPartida" :tema="temaGrafico" :height="200" />
    </UCard>
  </div>
</template>
